...
export class TrainingCreateComponent {
  ...
  frmCreate = this.formBuilder.group({
    ...
    date_expedition : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    qualification_entity_control : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    issue_date : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    registry_number : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    registry_center : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    date_resolution : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
    number_resolution : new FormControl<string>('',{ validators : [Validators.required] , nonNullable : false}),
